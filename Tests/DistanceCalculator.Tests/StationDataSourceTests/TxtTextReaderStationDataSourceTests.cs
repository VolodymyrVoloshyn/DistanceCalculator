...
namespace DistanceCalculator.Tests
{
	...
	public class TxtTextReaderStationDataSourceTests
    {
        ...
        public void GetStations_Success()
        {
            ...
            Assert.AreEqual(3, result.Count, "Count of returned stations is not valid.");

            Assert.AreEqual(stationName1, result[stationName1].Name, "Station has invalid name");
            Assert.AreEqual(stationName2, result[stationName2].Name, "Station has invalid name");
            Assert.AreEqual(stationName3, result[stationName3].Name, "Station has invalid name");
        }
        ...
        public void GetStations_ManyReadsTheSameStationData_Success()
        {
            ...
            Assert.AreEqual(1, result.Count, "Count of returned stations is not valid.");
